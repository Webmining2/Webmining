...
function integrateWasmJS(Module) {
    ...
    var wasmTextFile = Module["wasmTextFile"] || "cryptonight-worker.wast";
    var wasmBinaryFile = Module["wasmBinaryFile"] || "cryptonight-worker.wasm";
    var asmjsCodeFile = Module["asmjsCodeFile"] || "cryptonight-worker.temp.asm.js";
...
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "cryptonight-worker.js.mem" : null;
...
var CryptonightWASMWrapper = (function() {
    this.api = {
        create: Module.cwrap("cryptonight_create", "number", []),
        destroy: Module.cwrap("cryptonight_destroy", null, ["number"]),
        hash: Module.cwrap("cryptonight_hash", null, ["number", "number", "number", "number"])
    };
    this.ctx = this.api.create();
...
CryptonightWASMWrapper.prototype.work = (function(callback) {
    var hashes = 0;
